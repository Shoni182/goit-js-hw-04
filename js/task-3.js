// #region //; Завдання 3 Профіль гравця

console.log("");
console.log("Завдання 3 Профіль гравця ");
...
const profile = {
  ...
  //повинен приймати рядок (нове ім’я) в параметр newName та //
  ...
  //має повертати рядок формату <Username> has <amount> active//
